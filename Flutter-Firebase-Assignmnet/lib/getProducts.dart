...
//edit
  void _editProduct(String productId, String currentTitle, String currentDesc,
      double currentPrice) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Fetching Products Firestore"), actions: [
          GestureDetector(
                      ...
                      child: ListTile(
                          ...
                          trailing:
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                _editProduct(productId, doc["title"],
                                    doc["desc"], doc["price"]);
                              },
                            ),
                            IconButton(
